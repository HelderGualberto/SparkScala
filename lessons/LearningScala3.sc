object LearningScala3 {
  ...
  val str1: String = "andressa"
  val str2: String = "helder"
  val str3: String = "TeStE"
  val str4: String = "Jumento"

  transformString(str1, upper)
  transformString(str2, upper)
  transformString(str3, upper)
  transformString(str4, upper)

  transformString(str1, x => {x.toUpperCase()})
