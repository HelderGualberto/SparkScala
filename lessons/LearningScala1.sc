object LearningScala1 {
  ...
  val newNuber: Int = 123456;
  println(f"Zero padding on the left: $numberOne%05d")

  //It muest have the 0 appended before the number of times it needs to be repeated
  println(f"long new value is: $newNuber%010d")
  ...
  // The single & represent evaluation for both expressions and the the final comparison
  val impossible = isGreater & isLesser           //> impossible  : Boolean = false
  // The double && represent erly evaluation for the expression on the left side.
  // If its false than it already returns false, even befor evaluating the second expression
  ...
  val mypi = "3.1416"
  val pi_2 = mypi.toDouble * 2
  println(f"Value of 2 PI is: $pi_2%.3f")
